# Generated by Powerlevel10k configuration wizard on 2026-03-01 at 17:20 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=#65bcff # 39
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=#3b4261
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=#1e2030 # da627d # 167
#   typeset -g POWERLEVEL9K_DIR_BACKGROUND=#3b4261
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=#65bcff # 254
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#65bcff
  ...
  local anchor_files=(
    ...
    composer.json
    go.mod
    package.jsonrelease notes
    stack.yaml
  )
  typeset -g POWERLEVEL9K_SHORTEN_FOLDER_MARKER="(${(j:|:)anchor_files})"
  # If set to "first" ("last"), remove everything before the first (last) subdirectory that contains
  # files matching $POWERLEVEL9K_SHORTEN_FOLDER_MARKER. For example, when the current directory is
  # /foo/bar/git_repo/nested_git_repo/baz, prompt will display git_repo/nested_git_repo/baz (first)release notes
